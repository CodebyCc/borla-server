...
export const sendVerificationMail = async (token: string, profile: Profile) => {
  ...
  const welcomeMessage = `Hi ${name}, welcome to Borlaman! There are so much thing that we do for verified users. Use the given OTP to verify your email.`;
